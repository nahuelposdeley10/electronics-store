      ...
      <div className="footer-grid">
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li><button type="button" onClick={() => onNavigate('info', 'medios-de-pago')}>Formas de pago</button></li>
          </ul>
        </div>
        ...
        <div className="footer-col">
          <h3>Ayuda</h3>
          <ul>
            <li><button type="button" onClick={() => onNavigate('info', 'envios')}>Envíos</button></li>
            <li><button type="button" onClick={() => onNavigate('info', 'garantia')}>Garantía</button></li>
            <li><button type="button" onClick={() => onNavigate('info', 'devoluciones')}>Devoluciones</button></li>
            <li><button type="button" onClick={() => onNavigate('info', 'contacto')}>Contacto</button></li>
          </ul>
        </div>
