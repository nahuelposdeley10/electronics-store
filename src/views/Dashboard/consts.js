...
const ROLE_LABELS = {
  superadmin: 'Dueño general',
  admin: 'Dueño',
  operator: 'Vendedor',
}


export { STATUS_META, CATEGORY_LABELS, ROLE_LABELS, PENDING_GROUP, shortDate, shortId, initials, CASH_KIND_LABELS, CASH_KIND_CHIPS, PAYMENT_LABELS, PAYMENT_OPTIONS, salePaymentLabel, fullDate, idDoc, itemsSummary, QUOTE_STATUS_LABELS, MOVEMENT_TYPE_LABELS, STOCK_STATUS_LABELS, stockStatusOf, MOVEMENT_CHIPS, CHART_COLORS, CHART_TICK, CHART_GRID, compactARS, chartDayShort, REPORT_PERIODS, reportPaymentLabel, IMPORT_EXAMPLE, PERM_CODES, PERM_LABELS }